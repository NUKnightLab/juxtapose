...
(function (document, window) {
    ...
    function Graphic(properties, slider) {
        ...
        this.image.onload = function() {
            self.loaded = self.complete = true;
            slider._onComplete();
        };
    ...
    JXSlider.prototype = {
        ...
        calculateDims: function(width, height){
            ...
            if (this.isDisplayingError) { ratio = 1.5; }
            if (width) {
                height = width / ratio;
            } else if (height) {
                width = height * ratio;
        ...
        setWrapperDimensions: function() {
            var computedWidthAndHeight = getComputedWidthAndHeight(this.wrapper);
            var dims = this.calculateDims(computedWidthAndHeight.width, computedWidthAndHeight.height);
            if (this.isDisplayingError) { dims = this.calculateDims(computedWidthAndHeight.width, 0); }
            console.log(dims);
        ...
        _onComplete: function() {
            ...
            if (this.imgBefore && this.imgBefore.complete === true &&
